...
> **Problem type:** Binary Classification · **Dataset:** Pima Indians Diabetes Dataset

## Problem Framing

This case study addresses **diabetes risk classification** using binary classification techniques. The goal is to demonstrate an end-to-end ML workflow with reproducible methodology and business-aware interpretation.
...
**Best model performance:** ROC-AUC = 0.83, F1 = 0.79
...
```bash
# From the repo root
jupyter notebook case_studies/02_classification_diabetes/notebook.ipynb

# Or run the training script
python case_studies/02_classification_diabetes/train.py
```
